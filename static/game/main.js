...
const waringMessageElement = document.getElementById("warning-message");
...
function showWarningMessage(previousDisc, nextDisc, winnerDisc) {
  const message = waringMessage(previousDisc, nextDisc, winnerDisc);

  waringMessageElement.innerText = message;

  if (message === null) {
    waringMessageElement.style.display = "none";
  } else {
    waringMessageElement.style.display = "block";
  }
}

function waringMessage(previousDisc, nextDisc, winnerDisc) {
  if (nextDisc !== null) {
